...
- `hermes skills install skills-sh/skills-il/government-services/israeli-bureaucracy-decoder` — Decode Israeli gov letters/forms (Tax Authority, Bituach Leumi, municipalities) to plain language.
